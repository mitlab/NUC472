...
{
    SYS->GPH_MFPH = (SYS->GPH_MFPH & ~(SYS_GPH_MFPH_PH9MFP_Msk | SYS_GPH_MFPH_PH10MFP_Msk));
...
{
    SYS->GPH_MFPH = (SYS->GPH_MFPH & ~(SYS_GPH_MFPH_PH9MFP_Msk | SYS_GPH_MFPH_PH10MFP_Msk)) | (SYS_GPH_MFPH_PH9MFP_SPI2_MISO1 | SYS_GPH_MFPH_PH10MFP_SPI2_MOSI1);
}
...
int main(void)
{
    ...
    printf("\n+------------------------------------------------------------------------+\n");
    printf("|             NUC472/NUC442 SPI Quad Mode with Flash Sample Code         |\n");
    printf("+------------------------------------------------------------------------+\n");
