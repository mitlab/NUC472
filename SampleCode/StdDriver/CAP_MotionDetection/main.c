 ...
 * $Revision: 8 $
 * $Date: 14/08/05 3:34p $
 * @brief    Implement motion detection with image capture interface
 *
 * @note
...
void MotionDetection8x8(void)
{
    ...
    /* Enable External CAP Interrupt & Motion Detection Interrupt */
    CAP_EnableInt(CAP_INT_VIEN_Msk | CAP_INT_MDIEN_Msk);
